...
import { GeneralConfFormComponent } from './components/conf-forms/general-conf-form/general-conf-form.component';
import { HardwareConfFormComponent } from './components/conf-forms/hardware-conf-form/hardware-conf-form.component';
